...
import (
	...
	ably "github.com/ably/terraform-provider-ably/provider" // Import the upstream provider

	"github.com/moAlobaidi/pulumi-ably/provider/pkg/version"
)
...
const (
	...
	mainPkg = "ably"
	// modules:
	mainMod = "index" // the ably module
)

//go:embed cmd/pulumi-resource-ably/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-ably/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-ably/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "ably", ably.Provider(),
		...
		// convention is to have a function at "github.com/ably/terraform-provider-ably/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(ably.New(version.Version)()),
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing ably cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"ably", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/moAlobaidi/pulumi-ably",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/moAlobaidi/pulumi-ably/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("ably_", mainMod,
